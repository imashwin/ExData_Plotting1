...
plot(data$DateTime, data$Global_active_power, type="l", xlab="", ylab="Global Active Power", bg = "transparent")
...
legend("topright", legend = c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"), col = c("black","red","blue"), lty = c(1,1), bg = "transparent", bty = "n")

# create top-right
plot(data$DateTime, data$Voltage, type = "l", xlab = "datetime", ylab = "Voltage", bg = "transparent")

# create bottom-right
plot(data$DateTime, data$Global_reactive_power, type = "l", xlab = "datetime", bg = "transparent")
